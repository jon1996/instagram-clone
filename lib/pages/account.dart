...
import 'package:instagram/util/myAppBar.dart';
import 'package:instagram/util/mySVG.dart';
import 'package:instagram/util/userAppBar.dart';

import '../model/user.dart';
import '../util/bubble_stories.dart';
import '../util/myButton.dart';
import '../util/post_gred.dart';
import '../util/reel_grid.dart';
import '../util/save_grid.dart';
import '../util/user_bubble.dart';
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            UserButtons(),
           Row(children: [UserBubble(txt: "2003 ",),UserBubble(txt: "My love",),UserBubble(txt: "Uwase ❤️",)],),
          
            TabBar(tabs: [
              Tab(icon: SvgIconWidget(svgGrid),),
              Tab(icon: SvgIconWidget(svgReel),),
              Tab(icon: SvgIconWidget(svgPerson),),
            ], indicatorColor: Colors.black, indicatorSize: TabBarIndicatorSize.label,),
