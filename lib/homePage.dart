...
''';
  ...
  selectedItemColor: _selectedIndex == 3 ? Colors.white : Colors.black,
  unselectedItemColor: _selectedIndex == 3 ? Colors.white : Colors.black,
        ...
        items: [
          BottomNavigationBarItem(
            icon: SvgIconWidget(svgHome, svgColor: _selectedIndex == 3
            ? ColorFilter.mode(_selectedIndex == 3 ? Colors.white : Colors.black, BlendMode.srcIn)
            : ColorFilter.mode(Colors.black, BlendMode.srcIn),),
            label: 'Home',
          ),
          BottomNavigationBarItem(
            icon: SvgIconWidget(svgSearch,svgColor: _selectedIndex == 3
            ? ColorFilter.mode(_selectedIndex == 3 ? Colors.white : Colors.black, BlendMode.srcIn)
            : ColorFilter.mode(Colors.black, BlendMode.srcIn),),
            label: 'Search',
          ),
          BottomNavigationBarItem(
            icon: SvgIconWidget(svgAdd,svgColor: _selectedIndex == 3
            ? ColorFilter.mode(_selectedIndex == 3 ? Colors.white : Colors.black, BlendMode.srcIn)
            : ColorFilter.mode(Colors.black, BlendMode.srcIn),),
            label: 'add',
          ),
          BottomNavigationBarItem(
            icon: SvgIconWidget(svgReel,svgColor: _selectedIndex == 3
            ? ColorFilter.mode(_selectedIndex == 3 ? Colors.white : Colors.black, BlendMode.srcIn)
            : ColorFilter.mode(Colors.black, BlendMode.srcIn),),
            label: 'reels',
          ),
          BottomNavigationBarItem(
            icon: SvgIconWidget(svgPerson,svgColor: _selectedIndex == 3
            ? ColorFilter.mode(_selectedIndex == 3 ? Colors.white : Colors.black, BlendMode.srcIn)
            : ColorFilter.mode(Colors.black, BlendMode.srcIn),),
            label: 'account',
          ),
